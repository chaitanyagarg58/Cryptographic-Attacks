...
# ===== YOUR CODE BELOW =====
payload = "0"*30000 # TODO: This variable should finally contain the hex-string you want to send
# ===== YOUR CODE ABOVE =====
...
for level in range(100):
    ...
    l1 = list(bytes.fromhex(c1))
    guess = 1

    if 0 in l1:
        guess = 2

    # guess = 0 # TODO: Set guess to 1 or 2 accordingly if you think the correct answer is c1 vs. c2 respectively
    # ===== YOUR CODE ABOVE =====
